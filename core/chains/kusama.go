...
func Kusama() (int, error) {
	...
	if err != nil {
		log.Println(err)
		return 0, errors.New("create post request for Kusama")
	}
	...
	fmt.Println("The Nakamoto coefficient for Kusama is", nakamotoCoefficient)
